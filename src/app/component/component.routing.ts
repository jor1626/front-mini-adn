    ...
    children: [
      ...
      },
      {
        ...
        data: {
          ...
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'ngComponent' }, { title: 'Existencia de articulos' }]
        }
      },{
        ...
        data: {
          ...
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'ngComponent' }, { title: 'Estado resultado' }]
        }
      }
    ]
  }
